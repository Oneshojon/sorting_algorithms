...
/**
 * find_pow - Finds the power of a number
 * @x: The number
...
/**
 * seq_generator - Generate the sequence
...
/**
 * reverse_seq - The reverse sequence
...
/**
 * shell_sort - Sorting with the Shell sort algorithm
 * @array: Array to sort
 * @size: Size of array
 * Return: Nothing
 */
